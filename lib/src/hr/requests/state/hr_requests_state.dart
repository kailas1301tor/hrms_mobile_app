...
import 'package:hrms_mobile/src/hr/requests/model/leave_request_item.dart';
import 'package:hrms_mobile/src/hr/requests/model/loan_request_item.dart';
import 'package:hrms_mobile/src/hr/requests/model/salary_advance_request_item.dart';

part 'hr_requests_state.freezed.dart';

@freezed
sealed class HrRequestsState with _$HrRequestsState {
  const factory HrRequestsState({
