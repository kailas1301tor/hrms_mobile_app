...
class HrRequestCardBase extends StatelessWidget {
  const HrRequestCardBase({
    super.key,
    required this.name,
...
class HrRequestActionButton extends StatelessWidget {
  const HrRequestActionButton({
    super.key,
    required this.icon,
    required this.color,
