...
class LoanRequestsListView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final list = ref.watch(hrRequestsProvider.select((s) => s.loanRequests));
    final loaderState = ref.watch(
      hrRequestsProvider.select((s) => s.loanLoaderState),
    );
    final loadingMore = ref.watch(
      hrRequestsProvider.select((s) => s.loanLoadingMore),
    );
