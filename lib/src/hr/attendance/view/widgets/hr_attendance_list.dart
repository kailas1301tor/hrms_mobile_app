...
class HrAttendanceList extends ConsumerWidget {
  const HrAttendanceList({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final attendanceState = ref.watch(
      hrAttendanceProvider.select(
    ...
    if (attendanceState.$3 == LoaderState.loading && records.isEmpty) {
      return const _HrAttendanceListShimmer();
    }
...
class _HrAttendanceListShimmer extends StatelessWidget {
  const _HrAttendanceListShimmer();
