...
class HrLiveActionItems extends ConsumerWidget {
  const HrLiveActionItems({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (summaryState.$3 && summaryState.$1 == null) {
      return const _HrLiveActionItemsShimmer();
    }
...
class _HrLiveActionItemsShimmer extends StatelessWidget {
  const _HrLiveActionItemsShimmer();
