...
import 'package:hrms_mobile/src/admin/requests/model/leave_pending_response.dart';
import 'package:hrms_mobile/src/admin/requests/model/loan_pending_response.dart';
import 'package:hrms_mobile/src/admin/requests/model/salary_advance_pending_response.dart';
import 'package:hrms_mobile/src/admin/requests/model/submit_action_response.dart';

abstract class AdminRequestsRepo {
...
class AdminRequestsRepoImpl implements AdminRequestsRepo {
  final NetworkServices services;

  AdminRequestsRepoImpl(this.services);
