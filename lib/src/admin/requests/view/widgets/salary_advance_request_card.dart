...
import '../../model/salary_advance_request_item.dart';

import 'admin_request_card_common.dart';

class SalaryAdvanceRequestCard extends StatelessWidget {
  const SalaryAdvanceRequestCard({
    super.key,
  ...
  final SalaryAdvanceRequestItem request;
