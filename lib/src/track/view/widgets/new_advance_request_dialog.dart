...
class NewAdvanceRequestDialog extends ConsumerStatefulWidget {
  const NewAdvanceRequestDialog({super.key});

  @override
  ConsumerState<NewAdvanceRequestDialog> createState() =>
      _NewAdvanceRequestDialogState();
}

class _NewAdvanceRequestDialogState
    extends ConsumerState<NewAdvanceRequestDialog> {
                    ...
                    onPressed: createLoader
                        ...
                        : () async {
                            ...
                            final amount =
                                ...
                                0;
                            final success = await notifier.submitAdvanceRequest(
                              amount,
