...
class NewLoanRequestScreen extends ConsumerStatefulWidget {
  const NewLoanRequestScreen({super.key});

  @override
  ConsumerState<NewLoanRequestScreen> createState() =>
      _NewLoanRequestScreenState();
}

class _NewLoanRequestScreenState extends ConsumerState<NewLoanRequestScreen> {
